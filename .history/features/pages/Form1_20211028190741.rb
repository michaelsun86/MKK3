...
def Dependent_Number()
    $driver.find_element(:id, 'jumlah_tanggungan').location_once_scrolled_into_view
    sleep(3)
    $driver.find_element(:id, 'jumlah_tanggungan').send_keys("0")
    sleep(3)
    $driver.hide_keyboard
    sleep(3)
end 
...
def Home_Phone()
    $driver.find_element(:id, 'telepon_rumah').location_once_scrolled_into_view
    sleep(3)
    $driver.find_element(:id, 'telepon_rumah').send_keys("0274123456")
    sleep(3)
    $driver.hide_keyboard
    sleep(3)
end
...
def Mother_Name()
    $driver.find_element(:id, 'ibu_kandung').location_once_scrolled_into_view
    sleep(3)
    $driver.find_element(:id, 'ibu_kandung').send_keys("Ibu Kandung")
    sleep(3)
    $driver.hide_keyboard
    sleep(3)
end    
...
def CurrentAddress_Yes()
    $driver.find_element(:id, 'addr_match_BV_option_0').click
    sleep(3)
end    

def CurrentAddress_No()
    $driver.find_element(:id, 'addr_match_BV_option_1').click
    sleep(3)
end    

def Work_Type(name)
    $driver.find_element(:id, 'jenis_bukti_pendapatan').location_once_scrolled_into_view
    sleep(3)
...
def Monthly_Income()
    $driver.find_element(:id, 'pendapatan').send_keys("10000000")
    sleep(3)
    $driver.hide_keyboard
    sleep(3)
end    
