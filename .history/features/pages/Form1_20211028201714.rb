...
def CurrentAddress_Yes()
    $driver.find_element(:xpath, '//div[@class="wizard-tab-content"]/div[1]/div/fieldset[12]/div/div/div[1]').click
    sleep(3)
end    

def CurrentAddress_No()
    $driver.find_element(:xpath, '//div[@class="wizard-tab-content"]/div[1]/div/fieldset[12]/div/div/div[2]').click
    sleep(3)
end    
