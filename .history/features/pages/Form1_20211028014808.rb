...
def Npwp_Pic()
    ...
    file = File.join(Dir.pwd, filename)
    $driver.find_element(:xpath, '//div[@class="form-container-wrapper auto-height"]/div/div/div[2]/div[2]/div[1]/div[1]/fieldset[7]/div/div/label/div[1]/input').send_keys file
    sleep(10)
end